...
public class Program
{
	public static void Main()
	{
		Console.WriteLine("Nama : Basten Hugo Simanungkalit");
            ...
            karyawan1.No = 1;
            karyawan1.Nik = 190002740;
            karyawan1.Nama = "Van Basten";
            karyawan1.Gaji = 3000000;

            karyawan2.No = 2;
            karyawan2.Nik = 1900017002;
            karyawan2.Nama = "Prasasty Ananda";
            karyawan2.Gaji = 1000000;

            karyawan3.No = 3;
            karyawan3.Nik = 19332951;
            karyawan3.Nama = "Hugo Sanchez";
            karyawan3.Gaji = -100;
            ...
            Console.WriteLine("");
            Console.WriteLine("Naik gaji coy 10%");
            Console.WriteLine("");
            Console.WriteLine("| No |   NIK | Nama | Gaji     ");
            Console.WriteLine("----------------------------------------");
            karyawan1.BonusGaji();
